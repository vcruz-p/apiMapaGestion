...
public class PolygonService : IPolygonService
{
    ...
    public async Task<Polygon> CreateAsync(string name, string? description, List<List<List<double>>> coordinates, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Polygon?> UpdateAsync(Guid id, string? name, string? description, List<List<List<double>>>? coordinates, CancellationToken cancellationToken = default)
    {
